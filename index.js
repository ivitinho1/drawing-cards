/* 
    FETCH: -> é um metodo que serve para trabalharmos com APIS, esse FETCH nos retorna uma promise
    e no resolve dessa promise vai ter o objeto do retorno dessa API
*/
